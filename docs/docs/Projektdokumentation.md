...
Dies ist meine erste To-Do-Liste in Python, die ich im Rahmen meiner Umschulung entwickelt habe.
Ziel des Projekts ist die automatische Erstellung strukturierter To-Do-Listen mithilfe eines kleinen Sprachmodells.
...
Ich muss heute Zimmer aufräumen; Wäsche waschen; Müll rausbringen; E-Mails beantworten; Buch lesen
-exit zum Beenden.
...
Im Projektverzeichnis (C:\Projekt\SmartToDoListe) folgende Ordner erstellen:
   mkdir models
   mkdir models\tiny-llama-q4
   -GGUF-Datei in den Ordner models\tiny-llama-q4\ legen
   models\tiny-llama-q4\tinyllama-1.1b-chat-v1.0.Q4_K_S.gguf
